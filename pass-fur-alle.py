...
def clickTimeIfExists():
    try:
        ...
        # If form date is larger than your end booking date, or smaller than your start booking date, start over
        if formInputDateTime > endBookingDateDateTime or formInputDateTime < startBookingDateDateTime:
            if firstDate == True:
                time.sleep(15)
            setBookingDate()
            clickTimeIfExists()
